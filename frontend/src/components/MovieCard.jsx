  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`absolute top-2 right-2 w-8 h-8 rounded-full flex items-center justify-center transition-colors ${isFavorite ? 'bg-red-600' : 'bg-gray-800 bg-opacity-70 hover:bg-gray-700'
          }`}
      ...
      <button
        ...
        className={`absolute top-2 right-12 w-8 h-8 rounded-full flex items-center justify-center transition-colors ${isInWatchlist ? 'bg-blue-600' : 'bg-gray-800 bg-opacity-70 hover:bg-gray-700'
          }`}
